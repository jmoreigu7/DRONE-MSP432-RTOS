...
.dlls,em4f .dlls: drone_pepesteam.pem4f

-include package/cfg/drone_pepesteam_pem4f.mak
-include package/cfg/drone_pepesteam_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/drone_pepesteam_pem4f.dep
endif
drone_pepesteam.pem4f: package/cfg/drone_pepesteam_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
drone_pepesteam.pem4f package/cfg/drone_pepesteam_pem4f.c: .libraries,em4f
endif

package/cfg/drone_pepesteam_pem4f.c package/cfg/drone_pepesteam_pem4f.h package/cfg/drone_pepesteam_pem4f.xdl: override _PROG_NAME := drone_pepesteam.xem4f
package/cfg/drone_pepesteam_pem4f.c: package/cfg/drone_pepesteam_pem4f.cfg
package/cfg/drone_pepesteam_pem4f.xdc.inc: package/cfg/drone_pepesteam_pem4f.xdl
package/cfg/drone_pepesteam_pem4f.xdl package/cfg/drone_pepesteam_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/drone_pepesteam_pem4f.cfg
	-$(RM) package/cfg/drone_pepesteam_pem4f.dep
	-$(RM) package/cfg/drone_pepesteam_pem4f.c
	-$(RM) package/cfg/drone_pepesteam_pem4f.xdc.inc

clean,em4f::
	-$(RM) drone_pepesteam.pem4f
.executables,em4f .executables: drone_pepesteam.xem4f

drone_pepesteam.xem4f: |drone_pepesteam.pem4f

-include package/cfg/drone_pepesteam.xem4f.mak
drone_pepesteam.xem4f: package/cfg/drone_pepesteam_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/drone_pepesteam_pem4f.oem4f   package/cfg/drone_pepesteam_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
drone_pepesteam.xem4f: export C_DIR=
drone_pepesteam.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
drone_pepesteam.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

drone_pepesteam.test test,em4f test: drone_pepesteam.xem4f.test

drone_pepesteam.xem4f.test:: drone_pepesteam.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 drone_pepesteam.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.drone_pepesteam.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,drone_pepesteam.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) drone_pepesteam.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
drone_pepesteam_pem4f.oem4f,copy : package/cfg/drone_pepesteam_pem4f.oem4f
drone_pepesteam_pem4f.sem4f,copy : package/cfg/drone_pepesteam_pem4f.sem4f
