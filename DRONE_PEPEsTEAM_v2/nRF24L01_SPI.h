...
bool Iniciar_nRF24L01(SPI_Handle handle, uint8_t RX, uint8_t Canal, uint8_t Payload);


bool Flush_nRF24L01(SPI_Handle handle, uint8_t RX);

bool Escribir_Registro_nRF24L01(SPI_Handle handle, uint8_t Reg, uint8_t Dato);
bool Leer_Registro_nRF24L01(SPI_Handle handle, uint8_t Reg, uint8_t* Dato);

bool WritePayLoad_nRF24L01(SPI_Handle handle, uint8_t PayLoad, size_t n_PayLoad );
bool ReadPayLoad_nRF24L01(SPI_Handle handle, uint8_t* PayLoad, size_t n_PayLoad );

bool MandarByte_nRF24L01(SPI_Handle handle, uint8_t Dato);
bool RecibirByte_nRF24L01(SPI_Handle handle, uint8_t* Dato);
